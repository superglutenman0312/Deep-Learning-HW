...
# ========== Config ===========
MODEL_PATH = os.path.join("ckpt_test","step_40_reward_266_custom_24983.pth")        # 模型權重檔案的存放路徑
# MODEL_PATH = os.path.join(".","step_1_reward_598_custom_2825.pth")        # 模型權重檔案的存放路徑
